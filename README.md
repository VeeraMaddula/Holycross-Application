...
1. In Render, open the service > **Settings** > **Deploy Hook** and copy the URL shown there
   (generate one if there isn't one yet). Treat this URL as a secret — anyone with it can trigger
   a deploy.
